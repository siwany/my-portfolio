...
summary: "Built a customizable chatbot web app that acts as a personal assistant by answering questions about the user’s background, resume, and projects."
link: "https://github.com/siwany/personal-assistant"
---

## Overview

Built a customizable chatbot web app that acts as a personal assistant by answering questions about the user’s background, resume, and projects.
